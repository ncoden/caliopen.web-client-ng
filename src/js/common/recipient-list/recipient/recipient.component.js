import { KEY } from '../recipient-list.component.js';
import { createSelector } from 'reselect';

import { UNKNOWN_PROTOCOL_TYPE } from '../../protocol-icon/protocol-icon.component.js';
...
const RecipientComponent = {
  ...
  template: `
    <div class="m-badge m-badge--low m-badge--large">
      ...
      >
        <protocol-icon protocol="$ctrl.protocol"></protocol-icon>
      ...
      >
        <ul class="m-menu m-menu--vertical">
          ...
          >
            ...
            >
              <protocol-icon protocol="protocol"></protocol-icon>
