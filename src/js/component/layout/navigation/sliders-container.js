import { SLIDER_START, SLIDER_STOP } from './sliders.js';

export class NavigationSlidersContainerController {
...
export const LayoutNavigationSlidersContainerComponent = {
  controller: NavigationSlidersContainerController,
  ...
  template: `
    ...
    >
      <co-layout-navigation-sliders
        on-slider-event="$ctrl.preventCloseDropdown($event)"></co-layout-navigation-sliders>
    </div>
  `,
