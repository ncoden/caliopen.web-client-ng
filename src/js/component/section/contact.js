      ...
      <div class="s-contact__col-datas-online">
        ...
        <ul class="m-text-list s-contact__m-contact-detail-list">
          ...
          <li ng-if="!!$ctrl.editMode" class="m-text-list__item">
            <co-add-email-form contact="$ctrl.contact"></co-add-email-form>
          </li>
          ...
          <li ng-if="!!$ctrl.editMode" class="m-text-list__item">
            <co-add-im-form contact="$ctrl.contact"></co-add-im-form>
          </li>
          ...
          <li ng-if="!!$ctrl.editMode" class="m-text-list__item">
            <co-add-address-form contact="$ctrl.contact"></co-add-address-form>
          </li>
        </ul>
